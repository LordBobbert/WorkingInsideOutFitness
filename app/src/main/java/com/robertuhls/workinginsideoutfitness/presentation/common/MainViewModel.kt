package com.robertuhls.workinginsideoutfitness.presentation.common
...
import com.robertuhls.workinginsideoutfitness.presentation.login.auth.AuthState
...
class MainViewModel @Inject constructor(
    ...
    fun onEvent(event: AuthUiEvent) {
        when(event) {
            ...
            is AuthUiEvent.SignUpPhoneChanged -> {
                state = state.copy(signUpPhone = event.value)
            }
